    ...
    <div className="relative h-screen w-full overflow-hidden">
      ...
      >
        ...
        <div className="max-w-5xl mx-auto z-10">
          ...
          <h1
            ref={titleRef}
            className="text-5xl sm:text-6xl md:text-7xl font-bold mb-8 leading-tight opacity-0 tracking-tighter text-white drop-shadow-lg"
          >
            Experience the Future of{" "}
            <span className="relative">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-indigo-400 drop-shadow-sm">
                Premium Mobility
              </span>
          ...
          <p
            ref={subtitleRef}
            className="text-lg md:text-xl text-gray-100 mb-12 mt-6 max-w-2xl mx-auto opacity-0 drop-shadow-md"
          >
